...
describe('[Exercise 1] trimProperties', () => {
  ...
  test('[2] returns a copy, leaving the original object intact', () => {
    ...
    const expected = { foo: '  foo ', bar: 'bar ', baz: ' baz' }
    const expectedCopy = { foo: 'foo', bar: 'bar', baz: 'baz' }
...
describe('[Exercise 2] trimPropertiesMutation', () => {
  ...
  test('[4] the object returned is the exact same one we passed in', () => {
    ...
    expect(utils.trimPropertiesMutation(input)).not.toBe(expected)
...
describe('[Exercise 3] findLargestInteger', () => {
  test('[5] returns the largest number in an array of objects { integer: 2 }', () => {
    ...
    expect(utils.findLargestInteger(integers)).toBe(5)
  })
})
...
describe('[Exercise 4] Counter', () => {
  ...
  test('[6] the FIRST CALL of counter.countDown returns the initial count', () => {
    const initial = counter.countDown()
...
describe('[Exercise 6] Car', () => {
  ...
  test('[15] driving the car returns the updated odometer', () => {
    ...
    const odometer = focus.drive(5)

    expect(odometer).toBe(5)
